...
export default {
    ...
    execute: async({ hisoka, m, prefix, command, commands }) => {
        if (m.args.length >= 1) {
            ...
            let teks = `halo dek @${m.sender.split("@")[0]}, ini adalah daftar fitur yg tersedia ok\n\n`
            ...
            hisoka.sendMessage(m.from, 'https://telegra.ph//file/9cb86f764cac79c9793e2.png', {
                caption: teks,
                quoted: m,
                ...
                extra: {
                    ctwaContext: {
                        ...
                        thumbnail: (await Func.getFile('https://telegra.ph//file/9cb86f764cac79c9793e2.png')).data.toString('base64'),
                        mediaType: 1
                    }
                }
            })
